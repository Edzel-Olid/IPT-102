...
GO
PRINT N'Creating Table [dbo].[Info]...';
...
AS
BEGIN
	INSERT INTO [dbo].[Info] ( Firstname, Middleiniatial, Lastname) 
	VALUES ( @Firstname, @Middleiniatial, @Lastname)
END
GO
...
BEGIN
	...
	WHERE Id like @Find or Middleiniatial like @Find or Lastname like @Find 
END
GO
